...
<body ng-controller="appCtrl">
	...
	<div class="container">
		...
		<div class="col-md-12 header">
			<h1 align="center">
				<a href="<%=request.getContextPath()%>/">WalkingTree Inventory</a>
			</h1>
		</div>
					  ...
					  <div class="collapse navbar-collapse" id="myNavbar">
                            <ul class="nav navbar-nav">
                                ...
                                <c:if test="${user_id != null}">
                                    ...
                                    <li><a href="<%= request.getContextPath()%>/"><i class="fa fa-paypal"></i> Add Product</a></li>
                                    <li><a href="<%= request.getContextPath()%>/"><i class="fa fa-user-plus"></i> Register Customer</a></li> 
                                    <li><a href="<%= request.getContextPath()%>/"><i class="fa fa-area-chart"></i> Order Details</a></li> 
                                    </c:if>
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                <c:if test="${user_id == null}">
                                    ...
                                    <c:if test="${user_id != null}">
                                    <li><a href="<%= request.getContextPath()%>/"><span class="glyphicon glyphicon-log-out"></span> LogOut</a></li>
                                    </c:if>
                            </ul>
                        </div> 
				</div>
				...
				<div style="margin: 0 auto; width: 100%;">
					<div class="panel panel-default">
						...
						<div class="panel-footer">
							<p align="center">
								Don't have an account? Then click <a href="">Register</a>
							</p>
						</div>
					</div>
				</div>
